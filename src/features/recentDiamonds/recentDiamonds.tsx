                      ...
                      <div className="flex flex-col md:flex-row">
                        ...
                        <div
                          className={classNames(
                            ...
                            "inline-flex flex-grow-0 items-left px-2.5  rounded-full text-sm font-medium "
                          )}>
                          {person.changeType === "increase" ? (
                            <ArrowSmUpIcon
                              className="-ml-1 mr-0.5 flex-grow-0 self-center h-5 w-5 text-green-500"
                              aria-hidden="true"
                            />
                          ) : (
                            <ArrowSmDownIcon
                              className="-ml-1 mr-0.5 flex-grow-0 self-center h-5 w-5 text-red-500"
                              aria-hidden="true"
                            />
                          )}
